...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-md-4">
                    <h4 class="card-title border-bottom">Type Entry</h4>
                    <form method="post"

                          @if(isset($data->id)?$data->id :'')
                          action="{{ route('tracking-type.update', $data->id )}}">
                        <input name="_method" type="hidden" value="PUT">
                        @else
                            action="{{route('tracking-type.store')}}">
                        @endif
                        ...
                        <div class="row border-right">
                            ...
                            <div class="col-md-10  ">
                                ...
                                <input type="text" class="form-control" name="tr_type" autocomplete="off"
                                       id="tr_type" value="{{isset($data->tracking_type)?$data->tracking_type:''}}">
                            </div>
                            <div class="col-md-12">
                                <label>Status</label>
